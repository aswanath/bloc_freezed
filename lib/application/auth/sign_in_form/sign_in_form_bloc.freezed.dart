...
abstract class LoginPressed implements SignInFormEvent {
...
abstract class $SignInFormStateCopyWith<$Res> {
  ...
  $Res call({EmailAddress email, bool isValid, Password password});
}
...
class _$_SignInFormState implements _SignInFormState {
  const _$_SignInFormState(
      {required this.email, required this.isValid, required this.password});
  ...
  @override
  String toString() {
    return 'SignInFormState(email: $email, isValid: $isValid, password: $password)';
  }
